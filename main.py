...
driver.find_element(By.XPATH, "//input[@placeholder='Please enter your mobile number']").send_keys(username)
driver.find_element(By.XPATH, "//input[@placeholder='Please enter the password']").send_keys(password)
